...
seeds=(2026 2028 2029 2030 2031 2032 2035)
...
#SBATCH -J kd_small_2_${seed}
#SBATCH -t 4:00:00
#SBATCH --gres=gpu:1       # Changed to 1 GPU per job (since we are running 1 seed per job)
#SBATCH -c 4
#SBATCH --mem=64G          # Reduced memory (200G is likely overkill for 1 seed, adjust if needed)
...
bash ./scripts/bert_small_kd_fixed_alpha/small_kd_2.sh ${seed}
