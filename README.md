...
The implementation covers both language and vision tasks. Please prepare the datasets before running the experiments. We have included the following datasets and backbone neural models:
